...
FROM Krankenhausstatistik
WHERE Diagnose_Bezeichnung NOT LIKE '%Insgesamt%'
...
SELECT 
    ...
    CAST(SUM(insgesamt_80_bis_unter_85_Jahre) * 100.0 / NULLIF(SUM(insgesamt_insgesamt), 0) as DECIMAL(5,2)) as Senioren_80_85_Prozent
